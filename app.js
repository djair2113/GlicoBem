...
function getStoredData() {
  try {
    const data = localStorage.getItem('glicemia_records_martinha_v10');
...
function saveStoredData(data) {
  try {
    localStorage.setItem('glicemia_records_martinha_v10', JSON.stringify(data));
  } catch (err) {}
}
...
// HISTÓRICO COMPLETO COM TODOS OS REGISTROS + HOJE (20/09/2026 ÀS 11:00 = 154 mg/dL)
const HISTORICO_INICIAL = [
  {"id": 534, "dia": "20/09/2026 11:00", "momento": "Manhã", "valor": 154},
